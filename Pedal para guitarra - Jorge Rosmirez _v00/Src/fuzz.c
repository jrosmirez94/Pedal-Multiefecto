...
#define MIN_POTE 0
#define MAX_POTE 0X0FFF
#define MIN_PENDIENTE 0
#define MAX_PENDIENTE 0x7FFF
...
q15_t fuzz(q15_t x,q15_t pote)
{
	...
	for(i=0;i<CANT_THRESHOLD;i++)
	{
		pendiente[i]=(pote-MIN_POTE)*MAX_PENDIENTE/MAX_POTE+min_pendiente[i];
	}	
